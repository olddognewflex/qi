...
func TestParse(t *testing.T) {
	tests := []struct {
		...
		{name: "STT: Tel", in: "Tel Claude in the qi workspace to stop.", want: Intent{Kind: IntentInstruct, Target: Target{Kind: agentrt.KindClaude, Workspace: "qi"}, Instruction: "stop"}},
		{name: "STT: Tele", in: "Tele Claude in the qi workspace to stop.", want: Intent{Kind: IntentInstruct, Target: Target{Kind: agentrt.KindClaude, Workspace: "qi"}, Instruction: "stop"}},
		{name: "STT: Tail-clawed", in: "Tail-clawed in the qi workspace to stop.", want: Intent{Kind: IntentInstruct, Target: Target{Kind: agentrt.KindClaude, Workspace: "qi"}, Instruction: "stop"}},
		{name: "STT: cloud for Claude", in: "Tell cloud in ai-map to run the tests.", want: Intent{Kind: IntentInstruct, Target: Target{Kind: agentrt.KindClaude, Workspace: "ai-map"}, Instruction: "run the tests"}},
		{name: "hyphen inside a label survives", in: "Tell Codex in ai-map to stop.", want: Intent{Kind: IntentInstruct, Target: Target{Kind: agentrt.KindCodex, Workspace: "ai-map"}, Instruction: "stop"}},
